...
gpg --armor --clearsign --digest-algo SHA256 -u <8CHAR-SIGNATURE> /tmp/bitcurator-salt-$TAG_NAME.tar.gz.sha256

echo "==> Generating GPG Signature of tar.gz file"
gpg --armor --detach-sign -u <8CHAR-SIGNATURE> /tmp/bitcurator-salt-$TAG_NAME.tar.gz
